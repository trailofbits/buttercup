...
# From: https://github.com/tob-challenges/example-crs-architecture/blob/1ccabc62b177a86a49c69a5d3b085eea299223ce/docs/round_info/exhibition-round-2.md#challenge-tasks-archive
sim2() {
    full_set_duration=$((24 * $hours))
    delta_set_duration=$((8 * $hours))
...
# From: https://github.com/tob-challenges/example-crs-architecture/blob/main/docs/round_info/exhibition-round-3.md
sim3() {
...
single() {
    submit_task "$1" "duration" "$2"
    sleep "$2"
}

usage() {
    echo "Usage: $0 [sim1|sim2|sim3|all|testing|single <name> <duration>]"
    echo ""
    ...
    echo "single <name> <duration> = Run one challenge for a given duration in seconds."
    echo ""
