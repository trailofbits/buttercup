...
class TypesVulnSubmission(BaseModel):
    ...
    data_file: StrictStr = Field(description="Base64 encoded vuln trigger  2MiB max size before Base64 encoding")
    harness_name: Annotated[str, Field(strict=True, max_length=4096)] = Field(description="Fuzz Tooling Harness Name that exercises this vuln  4KiB max size")
    ...
    sarif: Optional[Dict[str, Any]] = Field(default=None, description="Optional SARIF Report compliant with the provided versioned SARIF schema")
