...
class Settings(BaseSettings):
    ...
    # Instance identification (read from CRS_INSTANCE_ID env var)
    crs_instance_id: Annotated[Optional[str], Field(default=None, env="CRS_INSTANCE_ID", description="CRS instance identifier")]
