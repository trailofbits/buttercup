...
class IndexRequest(_message.Message):
    __slots__ = ["build_type", "ossfuzz", "package_name", "source_path", "task_id"]
    BUILD_TYPE_FIELD_NUMBER: _ClassVar[int]
    OSSFUZZ_FIELD_NUMBER: _ClassVar[int]
    PACKAGE_NAME_FIELD_NUMBER: _ClassVar[int]
    SOURCE_PATH_FIELD_NUMBER: _ClassVar[int]
    ...
    source_path: str
    task_id: str
    def __init__(self, package_name: _Optional[str] = ..., ossfuzz: _Optional[str] = ..., source_path: _Optional[str] = ..., task_id: _Optional[str] = ..., build_type: _Optional[str] = ...) -> None: ...
