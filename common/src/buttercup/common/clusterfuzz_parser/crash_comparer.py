...
class CrashComparer:
    ...
    def is_similar(self):
        ...
        if longest_common_subsequence(crash_state_lines_1, crash_state_lines_2) >= self.SAME_FRAMES_THRESHOLD:
            return True
        ...
        for i in range(len(crash_state_lines_1)):
            ...
            similarity_ratio = _similarity_ratio(crash_state_lines_1[i], crash_state_lines_2[i])
            lines_compared += 1
