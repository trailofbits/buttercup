...
@pytest.fixture
def vuln_discovery_full_task(mock_challenge_task, mock_codequery, mock_project_yaml, mock_redis, mock_reproduce_multiple, mock_sarifs, mock_crash_submit):
...
class TestVulnDiscoveryFullTask:
    ...
    def test_init(self, vuln_discovery_full_task, mock_challenge_task, mock_codequery, mock_project_yaml, mock_redis, mock_reproduce_multiple, mock_sarifs, mock_crash_submit):
    ...
    def test_gather_context_generates_proper_command(self, vuln_discovery_full_task, mock_harness_info, mock_sarifs, temp_output_dir, temp_current_dir):
    ...
    def test_analyze_bug_creates_proper_command(self, vuln_discovery_full_task, mock_harness_info, mock_sarifs, temp_output_dir, temp_current_dir):
        ...
        with patch.object(vuln_discovery_full_task, '_analyze_bug_base', return_value=Mock(update={"analysis": mock_analysis})):
    ...
    def test_write_pov_creates_proper_command(self, vuln_discovery_full_task, mock_harness_info, mock_sarifs, temp_output_dir, temp_current_dir):
        ...
        with patch.object(vuln_discovery_full_task, '_write_pov_base', return_value=Mock(update={"generated_functions": mock_pov_functions})):
    ...
    def test_init_state_success(self, vuln_discovery_full_task, mock_harness_info, temp_output_dir, temp_current_dir):
        """Test _init_state success case."""
        with patch.object(vuln_discovery_full_task, 'get_harness_source', return_value=mock_harness_info):
    ...
    def test_init_state_no_harness(self, vuln_discovery_full_task, temp_output_dir, temp_current_dir):
    ...
    def test_submit_valid_pov_success(self, vuln_discovery_full_task, mock_build_output, mock_reproduce_result, temp_output_dir):
        ...
        with patch('buttercup.seed_gen.vuln_base_task.stack_parsing.get_crash_token', return_value="test_token"):
            vuln_discovery_full_task.submit_valid_pov(pov_file, mock_build_output, mock_reproduce_result)
    ...
    def test_submit_valid_pov_already_in_set(self, vuln_discovery_full_task, mock_build_output, mock_reproduce_result, temp_output_dir):
    ...
    def test_submit_valid_pov_no_crash_submit(self, vuln_discovery_full_task, mock_build_output, mock_reproduce_result, temp_output_dir):
    ...
    def test_submit_valid_pov_no_crash(self, vuln_discovery_full_task, mock_build_output, temp_output_dir):
    ...
    def test_submit_valid_pov_size_limit(self, vuln_discovery_full_task, mock_build_output, mock_reproduce_result, temp_output_dir):
    ...
    def test_test_povs_with_valid_crashes(self, vuln_discovery_full_task, mock_build_output, mock_reproduce_result, temp_output_dir, temp_current_dir):
    ...
    def test_continue_pov_write_logic(self, vuln_discovery_full_task, temp_output_dir, temp_current_dir):
    ...
    def test_do_task_success(self, vuln_discovery_full_task, mock_harness_info, temp_output_dir, temp_current_dir):
        ...
        with patch('buttercup.seed_gen.find_harness.get_harness_source', return_value=mock_harness_info):
            with patch.object(vuln_discovery_full_task, '_init_state') as mock_init_state:
                with patch.object(vuln_discovery_full_task, '_build_workflow') as mock_build_workflow:
                    mock_state = Mock()
                    ...
                    with patch('buttercup.seed_gen.vuln_discovery_full.get_langfuse_callbacks', return_value=[]):
    ...
    def test_do_task_exception_handling(self, vuln_discovery_full_task, temp_output_dir, temp_current_dir):
        """Test do_task exception handling."""
        with patch.object(vuln_discovery_full_task, '_init_state', side_effect=Exception("Test error")):
