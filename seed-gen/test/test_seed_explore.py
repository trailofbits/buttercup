...
def test_do_task_success(
    ...
    with (
        ...
        seed_explore_task.codequery.get_functions = Mock(return_value=mock_codequery_responses["get_functions"])
        seed_explore_task.codequery.get_callers = Mock(return_value=mock_codequery_responses["get_callers"])
        seed_explore_task.codequery.get_types = Mock(return_value=mock_codequery_responses["get_types"])
