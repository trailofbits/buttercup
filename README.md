...
## Accessing Langfuse LLM traces

Buttercup includes local Langfuse deployment by default for LLM observability.
You can access LLM traces generated by various components through the Langfuse UI:
